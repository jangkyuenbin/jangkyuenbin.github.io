...
return n.onclick=function(){max_page>=e&&e>=1&&(current_page=e,onSearch(null))},n.appendChild(t),n}function update_umbrella_page(e){for(var t=getLanguage(),n=[],l=0,a=0,o=document.getElementById("items_div");o.firstChild;)o.removeChild(o.firstChild)
var r=(current_page-1)*max_item,s=current_page*max_item
for(l=0;l<e.length;l++){if(1===e[l].show_flag){if(a>=r&&s>a){var c=get_node_div(id=e[l].id,url="./images/umbrella_png/"+e[l].pic_name,name=e[l].name[t],source=e[l].source[t],flag=e[l].own_flag)
o.appendChild(c)}a++}n.push(e[l].source[t])}n=Array.from(new Set(n)),n.sort()
...
update_umbrella_page(a),init_language()}else window.alert("load data Error!"),goto_home_page()}}var checkbox_select_list=[],current_page=1,max_page=10,max_item=18,tmp_inner_text=""